...
<body>
    <nav class="navbar navbar-expand-lg  px-0">
        <div class="container">
            ...
            <a class="navbar-brand fw-bold ms-2" href="../../">JONBIN</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-auto textnav">
                    <li class="nav-item">
                        <?php
                        echo ' <a class="nav-link active" aria-current="page" href="../companies/?category=""">Find a Job</a>'
                        ?>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ps-5" href="../about/index.php">About</a>
                    </li>
